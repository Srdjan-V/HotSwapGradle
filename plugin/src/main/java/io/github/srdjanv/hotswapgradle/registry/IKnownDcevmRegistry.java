    ...
    default void setDefaultRegistry() {
        ...
        populateRegistry(JavaVersion.VERSION_11, () -> {
            ...
            jdk11.add(dcevmSpec -> {
                ...
                dcevmSpec.getArguments().set(
                        Arrays.asList("-XX:+AllowEnhancedClassRedefinition",
        ...
        populateRegistry(JavaVersion.VERSION_17, () -> Collections.singletonList(dcevmSpec -> {
        ...
        populateRegistry(JavaVersion.VERSION_21, () -> Collections.singletonList(dcevmSpec -> {
            dcevmSpec.getLanguageVersion().set(JavaLanguageVersion.of(21));
            dcevmSpec.getVendor().set(JvmVendorSpec.JETBRAINS);
            dcevmSpec.getArguments().convention(
                    Arrays.asList("-XX:+AllowEnhancedClassRedefinition",
                            String.format("-javaagent:%s",
                                    dcevmSpec.getAgentJar().get().getAsFile().getAbsolutePath())
                    ));
